...
#      |TC_03_Pet_In_Store_XML_WithOnlyMandatoryFields        |ADD_PET  |200                 |
#      |TC_04_Pet_In_Store_JSON_WithOnlyMandatoryFields       |ADD_PET  |200                 |
      |TC_05_Pet_In_Store_XML_WithMultiplePicsAndTags        |ADD_PET  |200                 |
#      |TC_06_Pet_In_Store_JSON_WithMultiplePicsAndTags       |ADD_PET  |200                 |
#
#  @Regression
...
#    Examples:
#      |Unique_Test_Case_ID                                                |SheetName|ExpectedResponseCode|
#      |TC_07_Pet_In_Store_Json_Invalid_Details_MissingHeader_accept       |ADD_PET  |400                 |
#      |TC_08_Pet_In_Store_Json_Invalid_Details_MissingHeader_content-type |ADD_PET  |400                 |
#      |TC_09_Pet_In_Store_Json_Invalid_Details_wrong_PetStatus            |ADD_PET  |405                 |
